    ...
    return (
        <div className="card m-1 p-2">
            <div className="card-body">
                <div>
                <img className="img-fluid" src={`./data/static/products/${product.product.sku}-1-product.webp`} alt="card image"></img>
                ...
                <div className="d-flex flex-column">
                    ...
                    <div>
                        <div className="card-text">{product.product.description}</div>
